...
<div class="screenshot-frame screenshot-crop screenshot-semantic-crop">
<img src="assets/screenshots/textlab/live-deployed-2026-05-11/slide-semantic-search.png" alt="Semantic search results in TextLab with backend metadata and KWIC-like result table" class="screenshot-wide">
...
::: {.semantic-example}
::: {.syntax-reference}
English Reddit: `[word="London"]`. KWIC zeigt konkrete Belege; vorhandene Span-Annotationen können darüber als Entity-/NER-Layer sichtbar gemacht werden.
:::

<div class="screenshot-frame screenshot-crop screenshot-kwic-crop">
<img src="assets/screenshots/textlab/live-deployed-2026-05-11/slide-kwic-reddit-london-v2.png" alt="TextLab concordance view for London in English Reddit" class="screenshot-wide">
<div class="screenshot-caption">Konkordanz: Query → KWIC-Zeilen → interpretierbare Einzelkontexte; zusätzliche Annotationen bleiben als Layer anzeigbar.</div>
</div>
:::
...
<div class="screenshot-frame screenshot-crop screenshot-collocation-crop">
<img src="assets/screenshots/textlab/live-deployed-2026-05-11/slide-collocations-demokratie.png" alt="TextLab collocation module with ranked collocates and KWIC examples" class="screenshot-wide">
<div class="screenshot-caption">Kollokationen: Attribut, Fenster, Richtung und Score bestimmen, welche Nachbarschaften als auffällig erscheinen. Screenshot: deployed TextLab, 11.05.2026.</div>
</div>

::: {.syntax-reference}
Kollokationen sind eine Zählung über lokale Kontexte, nicht nur eine Liste “wichtiger Wörter”. Gute Beispiele brauchen deshalb Korpus, Query, Fenster, Attribut und Score.
:::
...
::: {.semantic-example}
::: {.syntax-reference}
TextLab projiziert Trefferkontexte als semantischen Raum: Cluster sind nur dann interpretierbar, wenn man die Belege darunter mitliest.
:::

<div class="screenshot-frame screenshot-crop screenshot-semantic-space-crop">
<img src="assets/screenshots/textlab/live-deployed-2026-05-11/slide-semantic-space-demokratie-v3.png" alt="TextLab semantic space with embedding model, cluster count and example concordances" class="screenshot-wide">
<div class="screenshot-caption">Semantic Space: Embeddings → Projektion → Cluster → Rückbindung an KWIC-Beispiele. Screenshot: deployed TextLab, 11.05.2026.</div>
</div>
:::
...
<div class="analysis-loop-slide">
<img src="assets/img/textlab-analyse-loop.svg" alt="Analyse-Loop in TextLab: Fragestellung, Korpus und Query, Modul und Parameter, Belege und Export, Rückbindung an Belege" class="analysis-loop-img">
</div>
